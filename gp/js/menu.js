...
function drawMenu(){
	...
	var divTestContent = document.getElementById("testContentArea");
...
//		nameSpanToAppend.style.left = "0px";
		...
		divTestContent.appendChild(divToAppend);
	...
	for(var i = 0 ; i < menuArray.length ; i++){
		...
		if(menuArray[i][1] == xIndex && menuArray[i][2] == yIndex){
			...
			if(innerObjectNameToModify.nodeName != "span"){
				...
				spanToAppend.style.position = "absolute";
